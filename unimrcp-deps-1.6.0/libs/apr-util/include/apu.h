...
/*
 * This definition indicates availability of the functions apr_queue_timedpop()
 * and apr_queue_timedpush(), which implement timed pop and push operations for
 * apr_queue_t.
 */
#define APR_HAS_QUEUE_TIMEOUT   1
