...
tag_typedef_t urltag_any;

EXPORT tag_typedef_t urltag_url_ref;
tag_typedef_t urltag_url;
...
{
  tag_typedef_t _urltag_any = NSTAG_TYPEDEF(*);
  tag_typedef_t _urltag_any_ref =
    REFTAG_TYPEDEF(urltag_any);
  tag_typedef_t _urltag_url = URLTAG_TYPEDEF(url);
  tag_typedef_t _urltag_url_ref =
    REFTAG_TYPEDEF(urltag_url);

  *(struct tag_type_s *)urltag_any = *_urltag_any;
  *(struct tag_type_s *)urltag_any_ref = *_urltag_any_ref;
  *(struct tag_type_s *)urltag_url = *_urltag_url;
  *(struct tag_type_s *)urltag_url_ref = *_urltag_url_ref;
