...
tag_typedef_t ntatag_bad_req_mask;
...
tag_typedef_t ntatag_bad_resp_mask;
...
tag_typedef_t ntatag_default_proxy;
...
tag_typedef_t ntatag_branch_key;
...
tag_typedef_t ntatag_ack_branch;
...
tag_typedef_t ntatag_max_proceeding;
...
tag_typedef_t ntatag_max_forwards;
...
tag_typedef_t ntatag_blacklist;
...
tag_typedef_t ntatag_debug_drop_prob;
...
tag_typedef_t ntatag_sigcomp_options;
...
tag_typedef_t ntatag_sigcomp_close;
...
tag_typedef_t ntatag_sigcomp_aware;
...
tag_typedef_t ntatag_sigcomp_algorithm;
...
tag_typedef_t ntatag_stateless;
...
tag_typedef_t ntatag_extra_100;
...
tag_typedef_t ntatag_timeout_408;
...
tag_typedef_t ntatag_merge_482;
...
tag_typedef_t ntatag_cancel_2543;
...
tag_typedef_t ntatag_cancel_408;
...
tag_typedef_t ntatag_cancel_487;
...
tag_typedef_t ntatag_use_timestamp;
...
tag_typedef_t ntatag_client_rport;
...
tag_typedef_t ntatag_server_rport;
...
tag_typedef_t ntatag_tcp_rport;
...
tag_typedef_t ntatag_tls_rport;
...
tag_typedef_t ntatag_use_naptr;
...
tag_typedef_t ntatag_s_irq_hash;
...
tag_typedef_t ntatag_s_orq_hash;
...
tag_typedef_t ntatag_s_leg_hash;
...
tag_typedef_t ntatag_s_irq_hash_used;
...
tag_typedef_t ntatag_s_leg_hash_used;
...
tag_typedef_t ntatag_s_recv_msg;
...
tag_typedef_t ntatag_s_recv_request;
...
tag_typedef_t ntatag_s_recv_response;
...
tag_typedef_t ntatag_s_bad_message;
...
tag_typedef_t ntatag_s_bad_request;
...
tag_typedef_t ntatag_s_bad_response;
...
tag_typedef_t ntatag_s_drop_request;
...
tag_typedef_t ntatag_s_drop_response;
...
tag_typedef_t ntatag_s_client_tr;
...
tag_typedef_t ntatag_s_server_tr;
...
tag_typedef_t ntatag_s_dialog_tr;
...
tag_typedef_t ntatag_s_acked_tr;
...
tag_typedef_t ntatag_s_canceled_tr;
...
tag_typedef_t ntatag_s_trless_request;
...
tag_typedef_t ntatag_s_trless_to_tr;
...
tag_typedef_t ntatag_s_trless_response;
...
tag_typedef_t ntatag_s_trless_200;
...
tag_typedef_t ntatag_s_merged_request;
...
tag_typedef_t ntatag_s_sent_msg;
...
tag_typedef_t ntatag_s_sent_request;
...
tag_typedef_t ntatag_s_sent_response;
...
tag_typedef_t ntatag_s_retry_request;
...
tag_typedef_t ntatag_s_recv_retry;
...
tag_typedef_t ntatag_s_tout_request;
...
tag_typedef_t ntatag_s_tout_response;

/* Internal */
EXPORT tag_typedef_t ntatag_delay_sending_ref;
tag_typedef_t ntatag_delay_sending;
EXPORT tag_typedef_t ntatag_incomplete_ref;
tag_typedef_t ntatag_incomplete;
...
{
  tag_typedef_t _ntatag_s_sent_msg =      	  USIZETAG_TYPEDEF(s_sent_msg);
  tag_typedef_t _ntatag_s_sent_msg_ref =
    REFTAG_TYPEDEF(ntatag_s_sent_msg);
  tag_typedef_t _ntatag_debug_drop_prob = UINTTAG_TYPEDEF(debug_drop_prob);
  tag_typedef_t _ntatag_debug_drop_prob_ref =
    REFTAG_TYPEDEF(ntatag_debug_drop_prob);
  tag_typedef_t _ntatag_aliases = SIPHDRTAG_NAMED_TYPEDEF(aliases, contact);
  tag_typedef_t _ntatag_aliases_ref =
    REFTAG_TYPEDEF(ntatag_aliases);
  tag_typedef_t _ntatag_s_recv_msg =         USIZETAG_TYPEDEF(s_recv_msg);
  tag_typedef_t _ntatag_s_recv_msg_ref =
    REFTAG_TYPEDEF(ntatag_s_recv_msg);
  tag_typedef_t _ntatag_cancel_408 = BOOLTAG_TYPEDEF(cancel_408);
  tag_typedef_t _ntatag_cancel_408_ref =
    REFTAG_TYPEDEF(ntatag_cancel_408);
  tag_typedef_t _ntatag_remote_cseq = UINTTAG_TYPEDEF(remote_cseq);
  tag_typedef_t _ntatag_remote_cseq_ref =
    REFTAG_TYPEDEF(ntatag_remote_cseq);
  tag_typedef_t _ntatag_sip_t1x64 = UINTTAG_TYPEDEF(sip_t1x64);
  tag_typedef_t _ntatag_sip_t1x64_ref =
    REFTAG_TYPEDEF(ntatag_sip_t1x64);
  tag_typedef_t _ntatag_rel100 = BOOLTAG_TYPEDEF(rel100);
  tag_typedef_t _ntatag_rel100_ref =
    REFTAG_TYPEDEF(ntatag_rel100);
  tag_typedef_t _ntatag_s_trless_response =  USIZETAG_TYPEDEF(s_trless_response);
  tag_typedef_t _ntatag_s_trless_response_ref =
    REFTAG_TYPEDEF(ntatag_s_trless_response);
  tag_typedef_t _ntatag_sigcomp_close = BOOLTAG_TYPEDEF(sigcomp_close);
  tag_typedef_t _ntatag_sigcomp_close_ref =
    REFTAG_TYPEDEF(ntatag_sigcomp_close);
  tag_typedef_t _ntatag_tag_3261 = BOOLTAG_TYPEDEF(tag_3261);
  tag_typedef_t _ntatag_tag_3261_ref =
    REFTAG_TYPEDEF(ntatag_tag_3261);
  tag_typedef_t _ntatag_s_retry_response =   USIZETAG_TYPEDEF(s_retry_response);
  tag_typedef_t _ntatag_s_retry_response_ref =
    REFTAG_TYPEDEF(ntatag_s_retry_response);
  tag_typedef_t _ntatag_comp = CSTRTAG_TYPEDEF(comp);
  tag_typedef_t _ntatag_comp_ref =
    REFTAG_TYPEDEF(ntatag_comp);
  tag_typedef_t _ntatag_s_recv_response =    USIZETAG_TYPEDEF(s_recv_response);
  tag_typedef_t _ntatag_s_recv_response_ref =
    REFTAG_TYPEDEF(ntatag_s_recv_response);
  tag_typedef_t _ntatag_s_drop_response =    USIZETAG_TYPEDEF(s_drop_response);
  tag_typedef_t _ntatag_s_drop_response_ref =
    REFTAG_TYPEDEF(ntatag_s_drop_response);
  tag_typedef_t _ntatag_s_sent_response = 	  USIZETAG_TYPEDEF(s_sent_response);
  tag_typedef_t _ntatag_s_sent_response_ref =
    REFTAG_TYPEDEF(ntatag_s_sent_response);
  tag_typedef_t _ntatag_s_tout_response =    USIZETAG_TYPEDEF(s_tout_response);
  tag_typedef_t _ntatag_s_tout_response_ref =
    REFTAG_TYPEDEF(ntatag_s_tout_response);
  tag_typedef_t _ntatag_stateless = BOOLTAG_TYPEDEF(stateless);
  tag_typedef_t _ntatag_stateless_ref =
    REFTAG_TYPEDEF(ntatag_stateless);
  tag_typedef_t _ntatag_s_bad_response =     USIZETAG_TYPEDEF(s_bad_response);
  tag_typedef_t _ntatag_s_bad_response_ref =
    REFTAG_TYPEDEF(ntatag_s_bad_response);
  tag_typedef_t _ntatag_blacklist = UINTTAG_TYPEDEF(blacklist);
  tag_typedef_t _ntatag_blacklist_ref =
    REFTAG_TYPEDEF(ntatag_blacklist);
  tag_typedef_t _ntatag_timeout_408 = BOOLTAG_TYPEDEF(timeout_408);
  tag_typedef_t _ntatag_timeout_408_ref =
    REFTAG_TYPEDEF(ntatag_timeout_408);
  tag_typedef_t _ntatag_s_irq_hash_used =    USIZETAG_TYPEDEF(s_irq_hash_used);
  tag_typedef_t _ntatag_s_irq_hash_used_ref =
    REFTAG_TYPEDEF(ntatag_s_irq_hash_used);
  tag_typedef_t _ntatag_s_orq_hash_used =    USIZETAG_TYPEDEF(s_orq_hash_used);
  tag_typedef_t _ntatag_s_orq_hash_used_ref =
    REFTAG_TYPEDEF(ntatag_s_orq_hash_used);
  tag_typedef_t _ntatag_s_leg_hash_used =    USIZETAG_TYPEDEF(s_leg_hash_used);
  tag_typedef_t _ntatag_s_leg_hash_used_ref =
    REFTAG_TYPEDEF(ntatag_s_leg_hash_used);
  tag_typedef_t _ntatag_pass_408 = BOOLTAG_TYPEDEF(pass_408);
  tag_typedef_t _ntatag_pass_408_ref =
    REFTAG_TYPEDEF(ntatag_pass_408);
  tag_typedef_t _ntatag_s_trless_request =   USIZETAG_TYPEDEF(s_trless_request);
  tag_typedef_t _ntatag_s_trless_request_ref =
    REFTAG_TYPEDEF(ntatag_s_trless_request);
  tag_typedef_t _ntatag_s_merged_request =   USIZETAG_TYPEDEF(s_merged_request);
  tag_typedef_t _ntatag_s_merged_request_ref =
    REFTAG_TYPEDEF(ntatag_s_merged_request);
  tag_typedef_t _ntatag_s_retry_request = 	  USIZETAG_TYPEDEF(s_retry_request);
  tag_typedef_t _ntatag_s_retry_request_ref =
    REFTAG_TYPEDEF(ntatag_s_retry_request);
  tag_typedef_t _ntatag_mclass = PTRTAG_TYPEDEF(mclass);
  tag_typedef_t _ntatag_mclass_ref =
    REFTAG_TYPEDEF(ntatag_mclass);
  tag_typedef_t _ntatag_s_recv_request =     USIZETAG_TYPEDEF(s_recv_request);
  tag_typedef_t _ntatag_s_recv_request_ref =
    REFTAG_TYPEDEF(ntatag_s_recv_request);
  tag_typedef_t _ntatag_s_drop_request =     USIZETAG_TYPEDEF(s_drop_request);
  tag_typedef_t _ntatag_s_drop_request_ref =
    REFTAG_TYPEDEF(ntatag_s_drop_request);
  tag_typedef_t _ntatag_s_client_tr =        USIZETAG_TYPEDEF(s_client_tr);
  tag_typedef_t _ntatag_s_client_tr_ref =
    REFTAG_TYPEDEF(ntatag_s_client_tr);
  tag_typedef_t _ntatag_s_sent_request =  	  USIZETAG_TYPEDEF(s_sent_request);
  tag_typedef_t _ntatag_s_sent_request_ref =
    REFTAG_TYPEDEF(ntatag_s_sent_request);
  tag_typedef_t _ntatag_s_tout_request =     USIZETAG_TYPEDEF(s_tout_request);
  tag_typedef_t _ntatag_s_tout_request_ref =
    REFTAG_TYPEDEF(ntatag_s_tout_request);
  tag_typedef_t _ntatag_s_bad_request =      USIZETAG_TYPEDEF(s_bad_request);
  tag_typedef_t _ntatag_s_bad_request_ref =
    REFTAG_TYPEDEF(ntatag_s_bad_request);
  tag_typedef_t _ntatag_any = NSTAG_TYPEDEF(*);
  tag_typedef_t _ntatag_any_ref =
    REFTAG_TYPEDEF(ntatag_any);
  tag_typedef_t _ntatag_bad_resp_mask = UINTTAG_TYPEDEF(bad_resp_mask);
  tag_typedef_t _ntatag_bad_resp_mask_ref =
    REFTAG_TYPEDEF(ntatag_bad_resp_mask);
  tag_typedef_t _ntatag_maxsize = USIZETAG_TYPEDEF(maxsize);
  tag_typedef_t _ntatag_maxsize_ref =
    REFTAG_TYPEDEF(ntatag_maxsize);
  tag_typedef_t _ntatag_s_trless_200 =       USIZETAG_TYPEDEF(s_trless_200);
  tag_typedef_t _ntatag_s_trless_200_ref =
    REFTAG_TYPEDEF(ntatag_s_trless_200);
  tag_typedef_t _ntatag_bad_req_mask = UINTTAG_TYPEDEF(bad_req_mask);
  tag_typedef_t _ntatag_bad_req_mask_ref =
    REFTAG_TYPEDEF(ntatag_bad_req_mask);
  tag_typedef_t _ntatag_s_canceled_tr =      USIZETAG_TYPEDEF(s_canceled_tr);
  tag_typedef_t _ntatag_s_canceled_tr_ref =
    REFTAG_TYPEDEF(ntatag_s_canceled_tr);
  tag_typedef_t _ntatag_s_acked_tr =         USIZETAG_TYPEDEF(s_acked_tr);
  tag_typedef_t _ntatag_s_acked_tr_ref =
    REFTAG_TYPEDEF(ntatag_s_acked_tr);
  tag_typedef_t _ntatag_use_timestamp = BOOLTAG_TYPEDEF(use_timestamp);
  tag_typedef_t _ntatag_use_timestamp_ref =
    REFTAG_TYPEDEF(ntatag_use_timestamp);
  tag_typedef_t _ntatag_max_proceeding = USIZETAG_TYPEDEF(max_proceeding);
  tag_typedef_t _ntatag_max_proceeding_ref =
    REFTAG_TYPEDEF(ntatag_max_proceeding);
  tag_typedef_t _ntatag_timer_c = UINTTAG_TYPEDEF(timer_c);
  tag_typedef_t _ntatag_timer_c_ref =
    REFTAG_TYPEDEF(ntatag_timer_c);
  tag_typedef_t _ntatag_graylist = UINTTAG_TYPEDEF(graylist);
  tag_typedef_t _ntatag_graylist_ref =
    REFTAG_TYPEDEF(ntatag_graylist);
  tag_typedef_t _ntatag_cancel_2543 = BOOLTAG_TYPEDEF(cancel_2543);
  tag_typedef_t _ntatag_cancel_2543_ref =
    REFTAG_TYPEDEF(ntatag_cancel_2543);
  tag_typedef_t _ntatag_use_naptr = BOOLTAG_TYPEDEF(naptr);
  tag_typedef_t _ntatag_use_naptr_ref =
    REFTAG_TYPEDEF(ntatag_use_naptr);
  tag_typedef_t _ntatag_sigcomp_algorithm = STRTAG_TYPEDEF(sigcomp_algorithm);
  tag_typedef_t _ntatag_sigcomp_algorithm_ref =
    REFTAG_TYPEDEF(ntatag_sigcomp_algorithm);
  tag_typedef_t _ntatag_sipflags = UINTTAG_TYPEDEF(sipflags);
  tag_typedef_t _ntatag_sipflags_ref =
    REFTAG_TYPEDEF(ntatag_sipflags);
  tag_typedef_t _ntatag_contact = SIPHDRTAG_NAMED_TYPEDEF(contact, contact);
  tag_typedef_t _ntatag_contact_ref =
    REFTAG_TYPEDEF(ntatag_contact);
  tag_typedef_t _ntatag_ua = BOOLTAG_TYPEDEF(ua);
  tag_typedef_t _ntatag_ua_ref =
    REFTAG_TYPEDEF(ntatag_ua);
  tag_typedef_t _ntatag_use_srv = BOOLTAG_TYPEDEF(srv);
  tag_typedef_t _ntatag_use_srv_ref =
    REFTAG_TYPEDEF(ntatag_use_srv);
  tag_typedef_t _ntatag_incomplete = BOOLTAG_TYPEDEF(incomplete);
  tag_typedef_t _ntatag_incomplete_ref =
    REFTAG_TYPEDEF(ntatag_incomplete);
  tag_typedef_t _ntatag_sigcomp_aware = BOOLTAG_TYPEDEF(sigcomp_aware);
  tag_typedef_t _ntatag_sigcomp_aware_ref =
    REFTAG_TYPEDEF(ntatag_sigcomp_aware);
  tag_typedef_t _ntatag_msg = PTRTAG_TYPEDEF(msg);
  tag_typedef_t _ntatag_msg_ref =
    REFTAG_TYPEDEF(ntatag_msg);
  tag_typedef_t _ntatag_preload = UINTTAG_TYPEDEF(preload);
  tag_typedef_t _ntatag_preload_ref =
    REFTAG_TYPEDEF(ntatag_preload);
  tag_typedef_t _ntatag_s_bad_message =      USIZETAG_TYPEDEF(s_bad_message);
  tag_typedef_t _ntatag_s_bad_message_ref =
    REFTAG_TYPEDEF(ntatag_s_bad_message);
  tag_typedef_t _ntatag_delay_sending = BOOLTAG_TYPEDEF(delay_sending);
  tag_typedef_t _ntatag_delay_sending_ref =
    REFTAG_TYPEDEF(ntatag_delay_sending);
  tag_typedef_t _ntatag_extra_100 = BOOLTAG_TYPEDEF(extra_100);
  tag_typedef_t _ntatag_extra_100_ref =
    REFTAG_TYPEDEF(ntatag_extra_100);
  tag_typedef_t _ntatag_default_proxy = URLTAG_TYPEDEF(default_proxy);
  tag_typedef_t _ntatag_default_proxy_ref =
    REFTAG_TYPEDEF(ntatag_default_proxy);
  tag_typedef_t _ntatag_client_rport = BOOLTAG_TYPEDEF(client_rport);
  tag_typedef_t _ntatag_client_rport_ref =
    REFTAG_TYPEDEF(ntatag_client_rport);
  tag_typedef_t _ntatag_server_rport = INTTAG_TYPEDEF(server_rport);
  tag_typedef_t _ntatag_server_rport_ref =
    REFTAG_TYPEDEF(ntatag_server_rport);
  tag_typedef_t _ntatag_user_via = BOOLTAG_TYPEDEF(user_via);
  tag_typedef_t _ntatag_user_via_ref =
    REFTAG_TYPEDEF(ntatag_user_via);
  tag_typedef_t _ntatag_tcp_rport = BOOLTAG_TYPEDEF(tcp_rport);
  tag_typedef_t _ntatag_tcp_rport_ref =
    REFTAG_TYPEDEF(ntatag_tcp_rport);
  tag_typedef_t _ntatag_tls_rport = BOOLTAG_TYPEDEF(tls_rport);
  tag_typedef_t _ntatag_tls_rport_ref =
    REFTAG_TYPEDEF(ntatag_tls_rport);
  tag_typedef_t _ntatag_no_dialog = BOOLTAG_TYPEDEF(no_dialog);
  tag_typedef_t _ntatag_no_dialog_ref =
    REFTAG_TYPEDEF(ntatag_no_dialog);
  tag_typedef_t _ntatag_max_forwards = UINTTAG_TYPEDEF(max_forwards);
  tag_typedef_t _ntatag_max_forwards_ref =
    REFTAG_TYPEDEF(ntatag_max_forwards);
  tag_typedef_t _ntatag_tport = PTRTAG_TYPEDEF(tport);
  tag_typedef_t _ntatag_tport_ref =
    REFTAG_TYPEDEF(ntatag_tport);
  tag_typedef_t _ntatag_s_trless_to_tr =     USIZETAG_TYPEDEF(s_trless_to_tr);
  tag_typedef_t _ntatag_s_trless_to_tr_ref =
    REFTAG_TYPEDEF(ntatag_s_trless_to_tr);
  tag_typedef_t _ntatag_s_recv_retry =       USIZETAG_TYPEDEF(s_recv_retry);
  tag_typedef_t _ntatag_s_recv_retry_ref =
    REFTAG_TYPEDEF(ntatag_s_recv_retry);
  tag_typedef_t _ntatag_udp_mtu = UINTTAG_TYPEDEF(udp_mtu);
  tag_typedef_t _ntatag_udp_mtu_ref =
    REFTAG_TYPEDEF(ntatag_udp_mtu);
  tag_typedef_t _ntatag_sip_t4 = UINTTAG_TYPEDEF(sip_t4);
  tag_typedef_t _ntatag_sip_t4_ref =
    REFTAG_TYPEDEF(ntatag_sip_t4);
  tag_typedef_t _ntatag_branch_key = STRTAG_TYPEDEF(branch_key);
  tag_typedef_t _ntatag_branch_key_ref =
    REFTAG_TYPEDEF(ntatag_branch_key);
  tag_typedef_t _ntatag_smime = PTRTAG_TYPEDEF(smime);
  tag_typedef_t _ntatag_smime_ref =
    REFTAG_TYPEDEF(ntatag_smime);
  tag_typedef_t _ntatag_sip_t2 = UINTTAG_TYPEDEF(sip_t2);
  tag_typedef_t _ntatag_sip_t2_ref =
    REFTAG_TYPEDEF(ntatag_sip_t2);
  tag_typedef_t _ntatag_sip_t1 = UINTTAG_TYPEDEF(sip_t1);
  tag_typedef_t _ntatag_sip_t1_ref =
    REFTAG_TYPEDEF(ntatag_sip_t1);
  tag_typedef_t _ntatag_method = STRTAG_TYPEDEF(method);
  tag_typedef_t _ntatag_method_ref =
    REFTAG_TYPEDEF(ntatag_method);
  tag_typedef_t _ntatag_rseq = UINTTAG_TYPEDEF(rseq);
  tag_typedef_t _ntatag_rseq_ref =
    REFTAG_TYPEDEF(ntatag_rseq);
  tag_typedef_t _ntatag_s_dialog_tr =        USIZETAG_TYPEDEF(s_dialog_tr);
  tag_typedef_t _ntatag_s_dialog_tr_ref =
    REFTAG_TYPEDEF(ntatag_s_dialog_tr);
  tag_typedef_t _ntatag_s_irq_hash =         USIZETAG_TYPEDEF(s_irq_hash);
  tag_typedef_t _ntatag_s_irq_hash_ref =
    REFTAG_TYPEDEF(ntatag_s_irq_hash);
  tag_typedef_t _ntatag_s_orq_hash =         USIZETAG_TYPEDEF(s_orq_hash);
  tag_typedef_t _ntatag_s_orq_hash_ref =
    REFTAG_TYPEDEF(ntatag_s_orq_hash);
  tag_typedef_t _ntatag_s_leg_hash =         USIZETAG_TYPEDEF(s_leg_hash);
  tag_typedef_t _ntatag_s_leg_hash_ref =
    REFTAG_TYPEDEF(ntatag_s_leg_hash);
  tag_typedef_t _ntatag_progress = UINTTAG_TYPEDEF(progress);
  tag_typedef_t _ntatag_progress_ref =
    REFTAG_TYPEDEF(ntatag_progress);
  tag_typedef_t _ntatag_pass_100 = BOOLTAG_TYPEDEF(pass_100);
  tag_typedef_t _ntatag_pass_100_ref =
    REFTAG_TYPEDEF(ntatag_pass_100);
  tag_typedef_t _ntatag_s_server_tr =        USIZETAG_TYPEDEF(s_server_tr);
  tag_typedef_t _ntatag_s_server_tr_ref =
    REFTAG_TYPEDEF(ntatag_s_server_tr);
  tag_typedef_t _ntatag_sigcomp_options = STRTAG_TYPEDEF(sigcomp_options);
  tag_typedef_t _ntatag_sigcomp_options_ref =
    REFTAG_TYPEDEF(ntatag_sigcomp_options);
  tag_typedef_t _ntatag_ack_branch = STRTAG_TYPEDEF(ack_branch);
  tag_typedef_t _ntatag_ack_branch_ref =
    REFTAG_TYPEDEF(ntatag_ack_branch);
  tag_typedef_t _ntatag_merge_482 = BOOLTAG_TYPEDEF(merge_482);
  tag_typedef_t _ntatag_merge_482_ref =
    REFTAG_TYPEDEF(ntatag_merge_482);
  tag_typedef_t _ntatag_cancel_487 = BOOLTAG_TYPEDEF(cancel_487);
  tag_typedef_t _ntatag_cancel_487_ref =
    REFTAG_TYPEDEF(ntatag_cancel_487);
  tag_typedef_t _ntatag_target = SIPHDRTAG_NAMED_TYPEDEF(target, contact);
  tag_typedef_t _ntatag_target_ref =
    REFTAG_TYPEDEF(ntatag_target);

  *(struct tag_type_s *)ntatag_s_sent_msg = *_ntatag_s_sent_msg;
  *(struct tag_type_s *)ntatag_s_sent_msg_ref = *_ntatag_s_sent_msg_ref;
  *(struct tag_type_s *)ntatag_debug_drop_prob = *_ntatag_debug_drop_prob;
  *(struct tag_type_s *)ntatag_debug_drop_prob_ref = *_ntatag_debug_drop_prob_ref;
  *(struct tag_type_s *)ntatag_s_recv_msg = *_ntatag_s_recv_msg;
  *(struct tag_type_s *)ntatag_s_recv_msg_ref = *_ntatag_s_recv_msg_ref;
  *(struct tag_type_s *)ntatag_aliases = *_ntatag_aliases;
  *(struct tag_type_s *)ntatag_aliases_ref = *_ntatag_aliases_ref;
  *(struct tag_type_s *)ntatag_cancel_408 = *_ntatag_cancel_408;
  *(struct tag_type_s *)ntatag_cancel_408_ref = *_ntatag_cancel_408_ref;
  *(struct tag_type_s *)ntatag_sip_t1x64 = *_ntatag_sip_t1x64;
  *(struct tag_type_s *)ntatag_sip_t1x64_ref = *_ntatag_sip_t1x64_ref;
  *(struct tag_type_s *)ntatag_remote_cseq = *_ntatag_remote_cseq;
  *(struct tag_type_s *)ntatag_remote_cseq_ref = *_ntatag_remote_cseq_ref;
  *(struct tag_type_s *)ntatag_s_trless_response = *_ntatag_s_trless_response;
  *(struct tag_type_s *)ntatag_s_trless_response_ref = *_ntatag_s_trless_response_ref;
  *(struct tag_type_s *)ntatag_rel100 = *_ntatag_rel100;
  *(struct tag_type_s *)ntatag_rel100_ref = *_ntatag_rel100_ref;
  *(struct tag_type_s *)ntatag_s_retry_response = *_ntatag_s_retry_response;
  *(struct tag_type_s *)ntatag_s_retry_response_ref = *_ntatag_s_retry_response_ref;
  *(struct tag_type_s *)ntatag_tag_3261 = *_ntatag_tag_3261;
  *(struct tag_type_s *)ntatag_tag_3261_ref = *_ntatag_tag_3261_ref;
  *(struct tag_type_s *)ntatag_sigcomp_close = *_ntatag_sigcomp_close;
  *(struct tag_type_s *)ntatag_sigcomp_close_ref = *_ntatag_sigcomp_close_ref;
  *(struct tag_type_s *)ntatag_s_tout_response = *_ntatag_s_tout_response;
  *(struct tag_type_s *)ntatag_s_tout_response_ref = *_ntatag_s_tout_response_ref;
  *(struct tag_type_s *)ntatag_s_sent_response = *_ntatag_s_sent_response;
  *(struct tag_type_s *)ntatag_s_sent_response_ref = *_ntatag_s_sent_response_ref;
  *(struct tag_type_s *)ntatag_s_drop_response = *_ntatag_s_drop_response;
  *(struct tag_type_s *)ntatag_s_drop_response_ref = *_ntatag_s_drop_response_ref;
  *(struct tag_type_s *)ntatag_s_recv_response = *_ntatag_s_recv_response;
  *(struct tag_type_s *)ntatag_s_recv_response_ref = *_ntatag_s_recv_response_ref;
  *(struct tag_type_s *)ntatag_comp = *_ntatag_comp;
  *(struct tag_type_s *)ntatag_comp_ref = *_ntatag_comp_ref;
  *(struct tag_type_s *)ntatag_s_bad_response = *_ntatag_s_bad_response;
  *(struct tag_type_s *)ntatag_s_bad_response_ref = *_ntatag_s_bad_response_ref;
  *(struct tag_type_s *)ntatag_stateless = *_ntatag_stateless;
  *(struct tag_type_s *)ntatag_stateless_ref = *_ntatag_stateless_ref;
  *(struct tag_type_s *)ntatag_timeout_408 = *_ntatag_timeout_408;
  *(struct tag_type_s *)ntatag_timeout_408_ref = *_ntatag_timeout_408_ref;
  *(struct tag_type_s *)ntatag_blacklist = *_ntatag_blacklist;
  *(struct tag_type_s *)ntatag_blacklist_ref = *_ntatag_blacklist_ref;
  *(struct tag_type_s *)ntatag_s_leg_hash_used = *_ntatag_s_leg_hash_used;
  *(struct tag_type_s *)ntatag_s_leg_hash_used_ref = *_ntatag_s_leg_hash_used_ref;
  *(struct tag_type_s *)ntatag_s_orq_hash_used = *_ntatag_s_orq_hash_used;
  *(struct tag_type_s *)ntatag_s_orq_hash_used_ref = *_ntatag_s_orq_hash_used_ref;
  *(struct tag_type_s *)ntatag_s_irq_hash_used = *_ntatag_s_irq_hash_used;
  *(struct tag_type_s *)ntatag_s_irq_hash_used_ref = *_ntatag_s_irq_hash_used_ref;
  *(struct tag_type_s *)ntatag_s_merged_request = *_ntatag_s_merged_request;
  *(struct tag_type_s *)ntatag_s_merged_request_ref = *_ntatag_s_merged_request_ref;
  *(struct tag_type_s *)ntatag_s_trless_request = *_ntatag_s_trless_request;
  *(struct tag_type_s *)ntatag_s_trless_request_ref = *_ntatag_s_trless_request_ref;
  *(struct tag_type_s *)ntatag_pass_408 = *_ntatag_pass_408;
  *(struct tag_type_s *)ntatag_pass_408_ref = *_ntatag_pass_408_ref;
  *(struct tag_type_s *)ntatag_s_retry_request = *_ntatag_s_retry_request;
  *(struct tag_type_s *)ntatag_s_retry_request_ref = *_ntatag_s_retry_request_ref;
  *(struct tag_type_s *)ntatag_s_tout_request = *_ntatag_s_tout_request;
  *(struct tag_type_s *)ntatag_s_tout_request_ref = *_ntatag_s_tout_request_ref;
  *(struct tag_type_s *)ntatag_s_sent_request = *_ntatag_s_sent_request;
  *(struct tag_type_s *)ntatag_s_sent_request_ref = *_ntatag_s_sent_request_ref;
  *(struct tag_type_s *)ntatag_s_client_tr = *_ntatag_s_client_tr;
  *(struct tag_type_s *)ntatag_s_client_tr_ref = *_ntatag_s_client_tr_ref;
  *(struct tag_type_s *)ntatag_s_drop_request = *_ntatag_s_drop_request;
  *(struct tag_type_s *)ntatag_s_drop_request_ref = *_ntatag_s_drop_request_ref;
  *(struct tag_type_s *)ntatag_s_recv_request = *_ntatag_s_recv_request;
  *(struct tag_type_s *)ntatag_s_recv_request_ref = *_ntatag_s_recv_request_ref;
  *(struct tag_type_s *)ntatag_mclass = *_ntatag_mclass;
  *(struct tag_type_s *)ntatag_mclass_ref = *_ntatag_mclass_ref;
  *(struct tag_type_s *)ntatag_s_bad_request = *_ntatag_s_bad_request;
  *(struct tag_type_s *)ntatag_s_bad_request_ref = *_ntatag_s_bad_request_ref;
  *(struct tag_type_s *)ntatag_any = *_ntatag_any;
  *(struct tag_type_s *)ntatag_any_ref = *_ntatag_any_ref;
  *(struct tag_type_s *)ntatag_s_trless_200 = *_ntatag_s_trless_200;
  *(struct tag_type_s *)ntatag_s_trless_200_ref = *_ntatag_s_trless_200_ref;
  *(struct tag_type_s *)ntatag_maxsize = *_ntatag_maxsize;
  *(struct tag_type_s *)ntatag_maxsize_ref = *_ntatag_maxsize_ref;
  *(struct tag_type_s *)ntatag_bad_resp_mask = *_ntatag_bad_resp_mask;
  *(struct tag_type_s *)ntatag_bad_resp_mask_ref = *_ntatag_bad_resp_mask_ref;
  *(struct tag_type_s *)ntatag_s_canceled_tr = *_ntatag_s_canceled_tr;
  *(struct tag_type_s *)ntatag_s_canceled_tr_ref = *_ntatag_s_canceled_tr_ref;
  *(struct tag_type_s *)ntatag_bad_req_mask = *_ntatag_bad_req_mask;
  *(struct tag_type_s *)ntatag_bad_req_mask_ref = *_ntatag_bad_req_mask_ref;
  *(struct tag_type_s *)ntatag_s_acked_tr = *_ntatag_s_acked_tr;
  *(struct tag_type_s *)ntatag_s_acked_tr_ref = *_ntatag_s_acked_tr_ref;
  *(struct tag_type_s *)ntatag_use_timestamp = *_ntatag_use_timestamp;
  *(struct tag_type_s *)ntatag_use_timestamp_ref = *_ntatag_use_timestamp_ref;
  *(struct tag_type_s *)ntatag_graylist = *_ntatag_graylist;
  *(struct tag_type_s *)ntatag_graylist_ref = *_ntatag_graylist_ref;
  *(struct tag_type_s *)ntatag_timer_c = *_ntatag_timer_c;
  *(struct tag_type_s *)ntatag_timer_c_ref = *_ntatag_timer_c_ref;
  *(struct tag_type_s *)ntatag_max_proceeding = *_ntatag_max_proceeding;
  *(struct tag_type_s *)ntatag_max_proceeding_ref = *_ntatag_max_proceeding_ref;
  *(struct tag_type_s *)ntatag_use_naptr = *_ntatag_use_naptr;
  *(struct tag_type_s *)ntatag_use_naptr_ref = *_ntatag_use_naptr_ref;
  *(struct tag_type_s *)ntatag_cancel_2543 = *_ntatag_cancel_2543;
  *(struct tag_type_s *)ntatag_cancel_2543_ref = *_ntatag_cancel_2543_ref;
  *(struct tag_type_s *)ntatag_sipflags = *_ntatag_sipflags;
  *(struct tag_type_s *)ntatag_sipflags_ref = *_ntatag_sipflags_ref;
  *(struct tag_type_s *)ntatag_sigcomp_algorithm = *_ntatag_sigcomp_algorithm;
  *(struct tag_type_s *)ntatag_sigcomp_algorithm_ref = *_ntatag_sigcomp_algorithm_ref;
  *(struct tag_type_s *)ntatag_contact = *_ntatag_contact;
  *(struct tag_type_s *)ntatag_contact_ref = *_ntatag_contact_ref;
  *(struct tag_type_s *)ntatag_incomplete = *_ntatag_incomplete;
  *(struct tag_type_s *)ntatag_incomplete_ref = *_ntatag_incomplete_ref;
  *(struct tag_type_s *)ntatag_use_srv = *_ntatag_use_srv;
  *(struct tag_type_s *)ntatag_use_srv_ref = *_ntatag_use_srv_ref;
  *(struct tag_type_s *)ntatag_ua = *_ntatag_ua;
  *(struct tag_type_s *)ntatag_ua_ref = *_ntatag_ua_ref;
  *(struct tag_type_s *)ntatag_sigcomp_aware = *_ntatag_sigcomp_aware;
  *(struct tag_type_s *)ntatag_sigcomp_aware_ref = *_ntatag_sigcomp_aware_ref;
  *(struct tag_type_s *)ntatag_s_bad_message = *_ntatag_s_bad_message;
  *(struct tag_type_s *)ntatag_s_bad_message_ref = *_ntatag_s_bad_message_ref;
  *(struct tag_type_s *)ntatag_preload = *_ntatag_preload;
  *(struct tag_type_s *)ntatag_preload_ref = *_ntatag_preload_ref;
  *(struct tag_type_s *)ntatag_msg = *_ntatag_msg;
  *(struct tag_type_s *)ntatag_msg_ref = *_ntatag_msg_ref;
  *(struct tag_type_s *)ntatag_delay_sending = *_ntatag_delay_sending;
  *(struct tag_type_s *)ntatag_delay_sending_ref = *_ntatag_delay_sending_ref;
  *(struct tag_type_s *)ntatag_extra_100 = *_ntatag_extra_100;
  *(struct tag_type_s *)ntatag_extra_100_ref = *_ntatag_extra_100_ref;
  *(struct tag_type_s *)ntatag_server_rport = *_ntatag_server_rport;
  *(struct tag_type_s *)ntatag_server_rport_ref = *_ntatag_server_rport_ref;
  *(struct tag_type_s *)ntatag_client_rport = *_ntatag_client_rport;
  *(struct tag_type_s *)ntatag_client_rport_ref = *_ntatag_client_rport_ref;
  *(struct tag_type_s *)ntatag_default_proxy = *_ntatag_default_proxy;
  *(struct tag_type_s *)ntatag_default_proxy_ref = *_ntatag_default_proxy_ref;
  *(struct tag_type_s *)ntatag_user_via = *_ntatag_user_via;
  *(struct tag_type_s *)ntatag_user_via_ref = *_ntatag_user_via_ref;
  *(struct tag_type_s *)ntatag_tls_rport = *_ntatag_tls_rport;
  *(struct tag_type_s *)ntatag_tls_rport_ref = *_ntatag_tls_rport_ref;
  *(struct tag_type_s *)ntatag_tcp_rport = *_ntatag_tcp_rport;
  *(struct tag_type_s *)ntatag_tcp_rport_ref = *_ntatag_tcp_rport_ref;
  *(struct tag_type_s *)ntatag_no_dialog = *_ntatag_no_dialog;
  *(struct tag_type_s *)ntatag_no_dialog_ref = *_ntatag_no_dialog_ref;
  *(struct tag_type_s *)ntatag_max_forwards = *_ntatag_max_forwards;
  *(struct tag_type_s *)ntatag_max_forwards_ref = *_ntatag_max_forwards_ref;
  *(struct tag_type_s *)ntatag_s_recv_retry = *_ntatag_s_recv_retry;
  *(struct tag_type_s *)ntatag_s_recv_retry_ref = *_ntatag_s_recv_retry_ref;
  *(struct tag_type_s *)ntatag_s_trless_to_tr = *_ntatag_s_trless_to_tr;
  *(struct tag_type_s *)ntatag_s_trless_to_tr_ref = *_ntatag_s_trless_to_tr_ref;
  *(struct tag_type_s *)ntatag_tport = *_ntatag_tport;
  *(struct tag_type_s *)ntatag_tport_ref = *_ntatag_tport_ref;
  *(struct tag_type_s *)ntatag_sip_t4 = *_ntatag_sip_t4;
  *(struct tag_type_s *)ntatag_sip_t4_ref = *_ntatag_sip_t4_ref;
  *(struct tag_type_s *)ntatag_udp_mtu = *_ntatag_udp_mtu;
  *(struct tag_type_s *)ntatag_udp_mtu_ref = *_ntatag_udp_mtu_ref;
  *(struct tag_type_s *)ntatag_sip_t2 = *_ntatag_sip_t2;
  *(struct tag_type_s *)ntatag_sip_t2_ref = *_ntatag_sip_t2_ref;
  *(struct tag_type_s *)ntatag_smime = *_ntatag_smime;
  *(struct tag_type_s *)ntatag_smime_ref = *_ntatag_smime_ref;
  *(struct tag_type_s *)ntatag_branch_key = *_ntatag_branch_key;
  *(struct tag_type_s *)ntatag_branch_key_ref = *_ntatag_branch_key_ref;
  *(struct tag_type_s *)ntatag_sip_t1 = *_ntatag_sip_t1;
  *(struct tag_type_s *)ntatag_sip_t1_ref = *_ntatag_sip_t1_ref;
  *(struct tag_type_s *)ntatag_s_dialog_tr = *_ntatag_s_dialog_tr;
  *(struct tag_type_s *)ntatag_s_dialog_tr_ref = *_ntatag_s_dialog_tr_ref;
  *(struct tag_type_s *)ntatag_rseq = *_ntatag_rseq;
  *(struct tag_type_s *)ntatag_rseq_ref = *_ntatag_rseq_ref;
  *(struct tag_type_s *)ntatag_method = *_ntatag_method;
  *(struct tag_type_s *)ntatag_method_ref = *_ntatag_method_ref;
  *(struct tag_type_s *)ntatag_s_leg_hash = *_ntatag_s_leg_hash;
  *(struct tag_type_s *)ntatag_s_leg_hash_ref = *_ntatag_s_leg_hash_ref;
  *(struct tag_type_s *)ntatag_s_orq_hash = *_ntatag_s_orq_hash;
  *(struct tag_type_s *)ntatag_s_orq_hash_ref = *_ntatag_s_orq_hash_ref;
  *(struct tag_type_s *)ntatag_s_irq_hash = *_ntatag_s_irq_hash;
  *(struct tag_type_s *)ntatag_s_irq_hash_ref = *_ntatag_s_irq_hash_ref;
  *(struct tag_type_s *)ntatag_progress = *_ntatag_progress;
  *(struct tag_type_s *)ntatag_progress_ref = *_ntatag_progress_ref;
  *(struct tag_type_s *)ntatag_s_server_tr = *_ntatag_s_server_tr;
  *(struct tag_type_s *)ntatag_s_server_tr_ref = *_ntatag_s_server_tr_ref;
  *(struct tag_type_s *)ntatag_pass_100 = *_ntatag_pass_100;
  *(struct tag_type_s *)ntatag_pass_100_ref = *_ntatag_pass_100_ref;
  *(struct tag_type_s *)ntatag_sigcomp_options = *_ntatag_sigcomp_options;
  *(struct tag_type_s *)ntatag_sigcomp_options_ref = *_ntatag_sigcomp_options_ref;
  *(struct tag_type_s *)ntatag_ack_branch = *_ntatag_ack_branch;
  *(struct tag_type_s *)ntatag_ack_branch_ref = *_ntatag_ack_branch_ref;
  *(struct tag_type_s *)ntatag_merge_482 = *_ntatag_merge_482;
  *(struct tag_type_s *)ntatag_merge_482_ref = *_ntatag_merge_482_ref;
  *(struct tag_type_s *)ntatag_cancel_487 = *_ntatag_cancel_487;
  *(struct tag_type_s *)ntatag_cancel_487_ref = *_ntatag_cancel_487_ref;
  *(struct tag_type_s *)ntatag_target = *_ntatag_target;
  *(struct tag_type_s *)ntatag_target_ref = *_ntatag_target_ref;
