...
tag_typedef_t tptag_sdwn_error;
...
tag_typedef_t tptag_sdwn_after;
...
tag_typedef_t tptag_close_after;
...
tag_typedef_t tptag_sigcomp_lifetime;
...
tag_typedef_t tptag_certificate;
...
tag_typedef_t tptag_compartment;
...
tag_typedef_t tptag_tls_version;
...
tag_typedef_t tptag_tls_verify_peer;
 ...
 * @NEW_1_12_11.
 */
EXPORT tag_typedef_t tptag_tls_passphrase_ref;
tag_typedef_t tptag_tls_passphrase;
 ...
 * @NEW_1_12_11.
 */
EXPORT tag_typedef_t tptag_tls_verify_policy_ref;
tag_typedef_t tptag_tls_verify_policy;
 ...
 * @NEW_1_12_11.
 */
EXPORT tag_typedef_t tptag_tls_verify_depth_ref;
tag_typedef_t tptag_tls_verify_depth;
 ...
 * @NEW_1_12_11.
 */
EXPORT tag_typedef_t tptag_tls_verify_date_ref;
tag_typedef_t tptag_tls_verify_date;
 ...
 * @NEW_1_12_11.
 */
EXPORT tag_typedef_t tptag_tls_verify_subjects_ref;
tag_typedef_t tptag_tls_verify_subjects;
...
tag_typedef_t tptag_debug_drop;
...
tag_typedef_t tptag_thrprqsize;
...
tag_typedef_t tptag_http_connect;
...
tag_typedef_t tptag_stun_server;
...
tag_typedef_t tptag_trusted;

#include <windows.h>

BOOL WINAPI DllMain(HINSTANCE hInst, DWORD fwdReason, LPVOID fImpLoad)
{
  tag_typedef_t _tptag_compartment = PTRTAG_TYPEDEF(compartment);
  tag_typedef_t _tptag_compartment_ref =
    REFTAG_TYPEDEF(tptag_compartment);
  tag_typedef_t _tptag_debug_drop = UINTTAG_TYPEDEF(debug_drop);
  tag_typedef_t _tptag_debug_drop_ref =
    REFTAG_TYPEDEF(tptag_debug_drop);
  tag_typedef_t _tptag_reuse = BOOLTAG_TYPEDEF(reuse);
  tag_typedef_t _tptag_reuse_ref =
    REFTAG_TYPEDEF(tptag_reuse);
  tag_typedef_t _tptag_tls_verify_peer = UINTTAG_TYPEDEF(tls_verify_peer);
  tag_typedef_t _tptag_tls_verify_peer_ref =
    REFTAG_TYPEDEF(tptag_tls_verify_peer);
  tag_typedef_t _tptag_http_connect = STRTAG_TYPEDEF(http_connect);
  tag_typedef_t _tptag_http_connect_ref =
    REFTAG_TYPEDEF(tptag_http_connect);
  tag_typedef_t _tptag_tls_verify_depth = UINTTAG_TYPEDEF(tls_verify_depth);
  tag_typedef_t _tptag_tls_verify_depth_ref =
    REFTAG_TYPEDEF(tptag_tls_verify_depth);
  tag_typedef_t _tptag_pingpong = UINTTAG_TYPEDEF(pingpong);
  tag_typedef_t _tptag_pingpong_ref =
    REFTAG_TYPEDEF(tptag_pingpong);
  tag_typedef_t _tptag_connect = BOOLTAG_TYPEDEF(connect);
  tag_typedef_t _tptag_connect_ref =
    REFTAG_TYPEDEF(tptag_connect);
  tag_typedef_t _tptag_mtu = USIZETAG_TYPEDEF(mtu);
  tag_typedef_t _tptag_mtu_ref =
    REFTAG_TYPEDEF(tptag_mtu);
  tag_typedef_t _tptag_close_after = BOOLTAG_TYPEDEF(sdwn_after);
  tag_typedef_t _tptag_close_after_ref =
    REFTAG_TYPEDEF(tptag_close_after);
  tag_typedef_t _tptag_trusted = BOOLTAG_TYPEDEF(trusted);
  tag_typedef_t _tptag_trusted_ref =
    REFTAG_TYPEDEF(tptag_trusted);
  tag_typedef_t _tptag_udp_rmem = UINTTAG_TYPEDEF(udp_rmem);
  tag_typedef_t _tptag_udp_rmem_ref =
    REFTAG_TYPEDEF(tptag_udp_rmem);
  tag_typedef_t _tptag_sdwn_after = BOOLTAG_TYPEDEF(sdwn_after);
  tag_typedef_t _tptag_sdwn_after_ref =
    REFTAG_TYPEDEF(tptag_sdwn_after);
  tag_typedef_t _tptag_dump = STRTAG_TYPEDEF(dump);
  tag_typedef_t _tptag_dump_ref =
    REFTAG_TYPEDEF(tptag_dump);
  tag_typedef_t _tptag_queuesize = UINTTAG_TYPEDEF(queuesize);
  tag_typedef_t _tptag_queuesize_ref =
    REFTAG_TYPEDEF(tptag_queuesize);
  tag_typedef_t _tptag_pong2ping = BOOLTAG_TYPEDEF(pong2ping);
  tag_typedef_t _tptag_pong2ping_ref =
    REFTAG_TYPEDEF(tptag_pong2ping);
  tag_typedef_t _tptag_idle = UINTTAG_TYPEDEF(idle);
  tag_typedef_t _tptag_idle_ref =
    REFTAG_TYPEDEF(tptag_idle);
  tag_typedef_t _tptag_tls_passphrase = STRTAG_TYPEDEF(tls_passphrase);
  tag_typedef_t _tptag_tls_passphrase_ref =
    REFTAG_TYPEDEF(tptag_tls_passphrase);
  tag_typedef_t _tptag_fresh = BOOLTAG_TYPEDEF(fresh);
  tag_typedef_t _tptag_fresh_ref =
    REFTAG_TYPEDEF(tptag_fresh);
  tag_typedef_t _tptag_thrprqsize = UINTTAG_TYPEDEF(thrprqsize);
  tag_typedef_t _tptag_thrprqsize_ref =
    REFTAG_TYPEDEF(tptag_thrprqsize);
  tag_typedef_t _tptag_thrpsize = UINTTAG_TYPEDEF(thrpsize);
  tag_typedef_t _tptag_thrpsize_ref =
    REFTAG_TYPEDEF(tptag_thrpsize);
  tag_typedef_t _tptag_public = INTTAG_TYPEDEF(public);
  tag_typedef_t _tptag_public_ref =
    REFTAG_TYPEDEF(tptag_public);
  tag_typedef_t _tptag_tls_version = UINTTAG_TYPEDEF(tls_version);
  tag_typedef_t _tptag_tls_version_ref =
    REFTAG_TYPEDEF(tptag_tls_version);
  tag_typedef_t _tptag_sigcomp_lifetime = UINTTAG_TYPEDEF(sigcomp_lifetime);
  tag_typedef_t _tptag_sigcomp_lifetime_ref =
    REFTAG_TYPEDEF(tptag_sigcomp_lifetime);
  tag_typedef_t _tptag_sdwn_error = BOOLTAG_TYPEDEF(sdwn_error);
  tag_typedef_t _tptag_sdwn_error_ref =
    REFTAG_TYPEDEF(tptag_sdwn_error);
  tag_typedef_t _tptag_keepalive = UINTTAG_TYPEDEF(keepalive);
  tag_typedef_t _tptag_keepalive_ref =
    REFTAG_TYPEDEF(tptag_keepalive);
  tag_typedef_t _tptag_log = INTTAG_TYPEDEF(log);
  tag_typedef_t _tptag_log_ref =
    REFTAG_TYPEDEF(tptag_log);
  tag_typedef_t _tptag_stun_server = BOOLTAG_TYPEDEF(stun_server);
  tag_typedef_t _tptag_stun_server_ref =
    REFTAG_TYPEDEF(tptag_stun_server);
  tag_typedef_t _tptag_any = NSTAG_TYPEDEF(*);
  tag_typedef_t _tptag_any_ref =
    REFTAG_TYPEDEF(tptag_any);
  tag_typedef_t _tptag_tls_verify_policy = UINTTAG_TYPEDEF(tls_verify_policy);
  tag_typedef_t _tptag_tls_verify_policy_ref =
    REFTAG_TYPEDEF(tptag_tls_verify_policy);
  tag_typedef_t _tptag_tos = INTTAG_TYPEDEF(tos);
  tag_typedef_t _tptag_tos_ref =
    REFTAG_TYPEDEF(tptag_tos);
  tag_typedef_t _tptag_tls_verify_subjects = PTRTAG_TYPEDEF(tls_verify_subjects);
  tag_typedef_t _tptag_tls_verify_subjects_ref =
    REFTAG_TYPEDEF(tptag_tls_verify_subjects);
  tag_typedef_t _tptag_server = BOOLTAG_TYPEDEF(server);
  tag_typedef_t _tptag_server_ref =
    REFTAG_TYPEDEF(tptag_server);
  tag_typedef_t _tptag_timeout = UINTTAG_TYPEDEF(timeout);
  tag_typedef_t _tptag_timeout_ref =
    REFTAG_TYPEDEF(tptag_timeout);
  tag_typedef_t _tptag_tls_verify_date = UINTTAG_TYPEDEF(tls_verify_date);
  tag_typedef_t _tptag_tls_verify_date_ref =
    REFTAG_TYPEDEF(tptag_tls_verify_date);
  tag_typedef_t _tptag_udp_wmem = UINTTAG_TYPEDEF(udp_wmem);
  tag_typedef_t _tptag_udp_wmem_ref =
    REFTAG_TYPEDEF(tptag_udp_wmem);
  tag_typedef_t _tptag_certificate = STRTAG_TYPEDEF(certificate);
  tag_typedef_t _tptag_certificate_ref =
    REFTAG_TYPEDEF(tptag_certificate);
  tag_typedef_t _tptag_ident = CSTRTAG_TYPEDEF(ident);
  tag_typedef_t _tptag_ident_ref =
    REFTAG_TYPEDEF(tptag_ident);

  *(struct tag_type_s *)tptag_compartment = *_tptag_compartment;
  *(struct tag_type_s *)tptag_compartment_ref = *_tptag_compartment_ref;
  *(struct tag_type_s *)tptag_debug_drop = *_tptag_debug_drop;
  *(struct tag_type_s *)tptag_debug_drop_ref = *_tptag_debug_drop_ref;
  *(struct tag_type_s *)tptag_reuse = *_tptag_reuse;
  *(struct tag_type_s *)tptag_reuse_ref = *_tptag_reuse_ref;
  *(struct tag_type_s *)tptag_tls_verify_peer = *_tptag_tls_verify_peer;
  *(struct tag_type_s *)tptag_tls_verify_peer_ref = *_tptag_tls_verify_peer_ref;
  *(struct tag_type_s *)tptag_http_connect = *_tptag_http_connect;
  *(struct tag_type_s *)tptag_http_connect_ref = *_tptag_http_connect_ref;
  *(struct tag_type_s *)tptag_pingpong = *_tptag_pingpong;
  *(struct tag_type_s *)tptag_pingpong_ref = *_tptag_pingpong_ref;
  *(struct tag_type_s *)tptag_tls_verify_depth = *_tptag_tls_verify_depth;
  *(struct tag_type_s *)tptag_tls_verify_depth_ref = *_tptag_tls_verify_depth_ref;
  *(struct tag_type_s *)tptag_connect = *_tptag_connect;
  *(struct tag_type_s *)tptag_connect_ref = *_tptag_connect_ref;
  *(struct tag_type_s *)tptag_mtu = *_tptag_mtu;
  *(struct tag_type_s *)tptag_mtu_ref = *_tptag_mtu_ref;
  *(struct tag_type_s *)tptag_close_after = *_tptag_close_after;
  *(struct tag_type_s *)tptag_close_after_ref = *_tptag_close_after_ref;
  *(struct tag_type_s *)tptag_sdwn_after = *_tptag_sdwn_after;
  *(struct tag_type_s *)tptag_sdwn_after_ref = *_tptag_sdwn_after_ref;
  *(struct tag_type_s *)tptag_udp_rmem = *_tptag_udp_rmem;
  *(struct tag_type_s *)tptag_udp_rmem_ref = *_tptag_udp_rmem_ref;
  *(struct tag_type_s *)tptag_trusted = *_tptag_trusted;
  *(struct tag_type_s *)tptag_trusted_ref = *_tptag_trusted_ref;
  *(struct tag_type_s *)tptag_dump = *_tptag_dump;
  *(struct tag_type_s *)tptag_dump_ref = *_tptag_dump_ref;
  *(struct tag_type_s *)tptag_queuesize = *_tptag_queuesize;
  *(struct tag_type_s *)tptag_queuesize_ref = *_tptag_queuesize_ref;
  *(struct tag_type_s *)tptag_pong2ping = *_tptag_pong2ping;
  *(struct tag_type_s *)tptag_pong2ping_ref = *_tptag_pong2ping_ref;
  *(struct tag_type_s *)tptag_idle = *_tptag_idle;
  *(struct tag_type_s *)tptag_idle_ref = *_tptag_idle_ref;
  *(struct tag_type_s *)tptag_fresh = *_tptag_fresh;
  *(struct tag_type_s *)tptag_fresh_ref = *_tptag_fresh_ref;
  *(struct tag_type_s *)tptag_tls_passphrase = *_tptag_tls_passphrase;
  *(struct tag_type_s *)tptag_tls_passphrase_ref = *_tptag_tls_passphrase_ref;
  *(struct tag_type_s *)tptag_thrprqsize = *_tptag_thrprqsize;
  *(struct tag_type_s *)tptag_thrprqsize_ref = *_tptag_thrprqsize_ref;
  *(struct tag_type_s *)tptag_public = *_tptag_public;
  *(struct tag_type_s *)tptag_public_ref = *_tptag_public_ref;
  *(struct tag_type_s *)tptag_thrpsize = *_tptag_thrpsize;
  *(struct tag_type_s *)tptag_thrpsize_ref = *_tptag_thrpsize_ref;
  *(struct tag_type_s *)tptag_sdwn_error = *_tptag_sdwn_error;
  *(struct tag_type_s *)tptag_sdwn_error_ref = *_tptag_sdwn_error_ref;
  *(struct tag_type_s *)tptag_sigcomp_lifetime = *_tptag_sigcomp_lifetime;
  *(struct tag_type_s *)tptag_sigcomp_lifetime_ref = *_tptag_sigcomp_lifetime_ref;
  *(struct tag_type_s *)tptag_tls_version = *_tptag_tls_version;
  *(struct tag_type_s *)tptag_tls_version_ref = *_tptag_tls_version_ref;
  *(struct tag_type_s *)tptag_keepalive = *_tptag_keepalive;
  *(struct tag_type_s *)tptag_keepalive_ref = *_tptag_keepalive_ref;
  *(struct tag_type_s *)tptag_log = *_tptag_log;
  *(struct tag_type_s *)tptag_log_ref = *_tptag_log_ref;
  *(struct tag_type_s *)tptag_stun_server = *_tptag_stun_server;
  *(struct tag_type_s *)tptag_stun_server_ref = *_tptag_stun_server_ref;
  *(struct tag_type_s *)tptag_any = *_tptag_any;
  *(struct tag_type_s *)tptag_any_ref = *_tptag_any_ref;
  *(struct tag_type_s *)tptag_tls_verify_policy = *_tptag_tls_verify_policy;
  *(struct tag_type_s *)tptag_tls_verify_policy_ref = *_tptag_tls_verify_policy_ref;
  *(struct tag_type_s *)tptag_tos = *_tptag_tos;
  *(struct tag_type_s *)tptag_tos_ref = *_tptag_tos_ref;
  *(struct tag_type_s *)tptag_server = *_tptag_server;
  *(struct tag_type_s *)tptag_server_ref = *_tptag_server_ref;
  *(struct tag_type_s *)tptag_tls_verify_subjects = *_tptag_tls_verify_subjects;
  *(struct tag_type_s *)tptag_tls_verify_subjects_ref = *_tptag_tls_verify_subjects_ref;
  *(struct tag_type_s *)tptag_timeout = *_tptag_timeout;
  *(struct tag_type_s *)tptag_timeout_ref = *_tptag_timeout_ref;
  *(struct tag_type_s *)tptag_tls_verify_date = *_tptag_tls_verify_date;
  *(struct tag_type_s *)tptag_tls_verify_date_ref = *_tptag_tls_verify_date_ref;
  *(struct tag_type_s *)tptag_ident = *_tptag_ident;
  *(struct tag_type_s *)tptag_ident_ref = *_tptag_ident_ref;
  *(struct tag_type_s *)tptag_certificate = *_tptag_certificate;
  *(struct tag_type_s *)tptag_certificate_ref = *_tptag_certificate_ref;
  *(struct tag_type_s *)tptag_udp_wmem = *_tptag_udp_wmem;
  *(struct tag_type_s *)tptag_udp_wmem_ref = *_tptag_udp_wmem_ref;
